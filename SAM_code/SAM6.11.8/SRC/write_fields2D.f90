...
if(.not.(SLM.or.(ocean_type.ne.0.or.dodynamicocean).and..not.dossthomo)) &
                 nfields=nfields-1
...
if(SLM.or.(ocean_type.ne.0.or.dodynamicocean).and..not.dossthomo) then
   nfields1=nfields1+1
   do j=1,ny
    do i=1,nx
