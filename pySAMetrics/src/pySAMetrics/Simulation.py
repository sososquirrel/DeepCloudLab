...
from pySAMetrics.old_stuff.diagnotic_fmse import diagnostic_fmse_z
...
class Simulation:
    ...
    def __init__(
        ...
        self.color = get_simulation_color(bowen_ratio=self.bowen_ratio, temperature=self.temperature, velocity=self.velocity)
    ...
    def load(self, backup_folder_path, load_all: bool = True, problem=False):
    ...
    def set_basic_variables_from_dataset(self):
        ...
        FMSE = (
            ...
            #- pySAMetrics.LATENT_HEAT_ICE * qi_values
        )
