...
if __name__ == "__main__":
    ...
    simu = load_simulation(parameters, i=1000, path_raw_data='/Volumes/LaCie/000_POSTDOC_2025/control_short')
    ...
    for i in tqdm(range(500,700)):  # from time step 0 to 20
        ...
        filename = os.path.join('/Users/sophieabramian/Documents/DeepCloudLab/pySAMetrics/notebooks/script_video_control', f'img_{str(i).zfill(3)}')
