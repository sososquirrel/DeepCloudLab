...
if __name__ == "__main__":
    ...
    for i_file,file in tqdm(enumerate(list_files, start=6)):
        print('Run', file)
        ...
        for i in tqdm(range(nt)):  # from time step 0 to 20
            ...
            filename = os.path.join(
                '/Volumes/LaCie/000_POSTDOC_2025/long_high_res/video_img_long_june',
