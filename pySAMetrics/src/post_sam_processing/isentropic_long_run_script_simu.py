...
def load_simulation(simu_parameters, i=1000):
    ...
    try:
        if i!=1000:
            paths = {
            'path_3d': f'/Users/sophieabramian/Documents/DeepCloudLab/data/3D/split_{i+1}.nc',
            'path_2d': f'/Users/sophieabramian/Documents/DeepCloudLab/data/2D/split_{i+1}.nc',
            'path_1d': f'/Users/sophieabramian/Documents/DeepCloudLab/data/1D/split_{i+1}.nc'
            }
...
if __name__ == "__main__":
    for i_file,file in tqdm(enumerate(list_files)):
        print('Run', file)
        parameters = data_dict[file]
        simu = load_simulation(simu_parameters=parameters, i=i_file)

        print(f'ok simu {parameters}!!')
        ...
        if simu:
            ...
            simu.save(backup_folder_path=f'/Users/sophieabramian/Documents/DeepCloudLab/data/long_run_RCE_T300_U0_B1_M1_split_{i_file}')
