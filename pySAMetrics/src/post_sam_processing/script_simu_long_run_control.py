...
data_dict = {
    'split_1': {'velocity': '0', 'temperature': '300', 'bowen_ratio': '1', 'microphysic': '1', 'split':'1'},
    'split_2': {'velocity': '0', 'temperature': '300', 'bowen_ratio': '1', 'microphysic': '1', 'split':'2'},
    'split_3': {'velocity': '0', 'temperature': '300', 'bowen_ratio': '1', 'microphysic': '1', 'split':'3'},
    'split_4': {'velocity': '0', 'temperature': '300', 'bowen_ratio': '1', 'microphysic': '1', 'split':'4'},
    'split_5': {'velocity': '0', 'temperature': '300', 'bowen_ratio': '1', 'microphysic': '1', 'split':'5'},
    'split_6': {'velocity': '0', 'temperature': '300', 'bowen_ratio': '1', 'microphysic': '1', 'split':'6'},
    'split_7': {'velocity': '0', 'temperature': '300', 'bowen_ratio': '1', 'microphysic': '1', 'split':'7'},
    'split_8': {'velocity': '0', 'temperature': '300', 'bowen_ratio': '1', 'microphysic': '1', 'split':'8'},
    'split_9': {'velocity': '0', 'temperature': '300', 'bowen_ratio': '1', 'microphysic': '1', 'split':'9'},
    'split_10': {'velocity': '0', 'temperature': '300', 'bowen_ratio': '1', 'microphysic': '1', 'split':'10'}
}


def load_simulation(simu_parameters, i=1000, path_raw_data='/Users/sophieabramian/Documents/DeepCloudLab/data/control'):
    """
...
if __name__ == "__main__":
    print_memory_usage("Before loading simulation")
    parameters = data_dict[list_files[0]]
    simu = load_simulation(parameters, i=0)
    print_memory_usage("After loading simulation") 
    print(simu.name)
    ...
    if simu:
        ...
        print_memory_usage("before var") 
        simu.set_basic_variables_from_dataset()
        print_memory_usage("After set_basic_variables_from_dataset")
        """
        simu.save(backup_folder_path='/Users/sophieabramian/Documents/DeepCloudLab/data/control/back_up_folder_path')
...
if __name__ == "__main__":
    for i_file,file in tqdm(enumerate(list_files[:1])):
        ...
        if simu:
            #simu.load(backup_folder_path=f'/Users/sophieabramian/Documents/DeepCloudLab/data/control/back_up_folder_path')
