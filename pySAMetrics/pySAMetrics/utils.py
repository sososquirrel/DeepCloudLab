...
def generate_simulation_paths(velocity: str, temperature: str, bowen_ratio: str, microphysic: str, folder_path:str='/burg/glab/users/sga2133/SAM_simulation_storage') -> dict:
    """
